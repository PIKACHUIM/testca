...
var findCjkFont = function () {
    var forceTtc = process.env.PIKA_FORCE_TTC === '1';
    var candidates = forceTtc
        ? [
...
export var buildPdf = function (opts) {
        ...
        if (fp) {
            try {
                if (fp.toLowerCase().endsWith('.ttc')) {
                    ...
                    var fontkit = req('fontkit');
                    var collection = fontkit.openSync(fp);
                    var first = (_b = collection.fonts) === null || _b === void 0 ? void 0 : _b[0];
                    var psName = (_c = first === null || first === void 0 ? void 0 : first.postscriptName) !== null && _c !== void 0 ? _c : collection.postscriptName;
                    if (psName) {
                ...
                console.warn('[build-pdfs] CJK font load failed:', e.message);
            }
        }
        else {
            console.warn('[build-pdfs] No CJK font found, Chinese PDF may render incorrectly.');
        }
    }
    ...
    doc
        ...
        .fontSize(10)
        .text((_d = opts.subtitle) !== null && _d !== void 0 ? _d : '', 0, 14, {
        align: 'right',
